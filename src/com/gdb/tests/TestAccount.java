...
public class TestAccount {
  public static void main(String[] args) {
    ...
    // TODO: After completing all 6 steps in Account.java, uncomment the test calls
    // below and run
    // this program. Your output should match the "Expected Output" section of
    // README.md.
    ...
    System.out.println("Withdraw 10000 (exceeds balance): " + (failWith ? "SUCCESS" : "FAILED") + " | Balance: Rs "
        + acc.getBalance());
  }
}
